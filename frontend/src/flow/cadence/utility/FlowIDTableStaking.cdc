...
pub contract FlowIDTableStaking {
    ...
    pub resource NodeRecord {
        ...
        pub fun nodeFullCommittedBalance(): UFix64 {
        ...
        pub fun borrowDelegatorRecord(_ delegatorID: UInt32): &DelegatorRecord {
            pre {
        ...
        pub fun setDelegator(delegatorID: UInt32, delegator: @DelegatorRecord) {
    ...
    pub fun borrowNodeRecord(_ nodeID: String): &NodeRecord {
        pre {
    ...
    pub fun borrowFeesAdmin(): &FlowFees.Administrator {
    ...
    pub fun updateClaimed(path: StoragePath, _ key: String, claimed: Bool) {
    ...
    pub fun getClaimed(path: StoragePath, key: String): Bool {
		let claimedDictionary = self.account.borrow<&{String: Bool}>(from: path)
            ?? panic("Invalid path for dictionary")
