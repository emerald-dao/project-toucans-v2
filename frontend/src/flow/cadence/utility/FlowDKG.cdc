...
pub contract FlowDKG {
    ...
    pub var finalSubmissionByNodeID: {String: [String?]}
    ...
    pub var uniqueFinalSubmissions: [[String?]]

    /// Tracks how many submissions have been sent
    /// for each unique final submission
    pub var uniqueFinalSubmissionCount: {Int: UInt64}
    ...
    pub fun submissionsEqual(_ existingSubmission: [String?], _ submission: [String?]): Bool {
