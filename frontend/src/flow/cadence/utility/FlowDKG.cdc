...
access(all) contract FlowDKG {
    ...
    access(all) var finalSubmissionByNodeID: {String: [String?]}
    ...
    access(all) var uniqueFinalSubmissions: [[String?]]

    /// Tracks how many submissions have been sent
    /// for each unique final submission
    access(all) var uniqueFinalSubmissionCount: {Int: UInt64}
    ...
    access(all) fun submissionsEqual(_ existingSubmission: [String?], _ submission: [String?]): Bool {
    ...
    access(all) fun participantIsRegistered(_ nodeID: String): Bool {
    ...
    access(all) fun participantIsClaimed(_ nodeID: String): Bool? {
    ...
    access(all) fun getNodeFinalSubmission(_ nodeID: String): [String?]? {
        if let submission = self.finalSubmissionByNodeID[nodeID] {
    ...
    access(all) fun getNativeSuccessThreshold(): UInt64 {
