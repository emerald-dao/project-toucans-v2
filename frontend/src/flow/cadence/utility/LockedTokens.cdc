...
access(all) contract LockedTokens {
    ...
    access(all) resource interface LockedAccountInfo {
        ...
        access(all) fun getNodeID(): String?
        access(all) fun getDelegatorID(): UInt32?
        access(all) fun getDelegatorNodeID(): String?
    }
    ...
    access(all) resource TokenHolder: FungibleToken.Receiver, FungibleToken.Provider, LockedAccountInfo {
        ...
        /// in the shared account
        access(all) var tokenManager: Capability<&LockedTokenManager>
        ...
        access(all) fun borrowTokenManager(): &LockedTokenManager {
